---
title: Dator
description: Vilken typ av dator krävs för studierna.
sidebar:
    order: 120
---
...
<Figure 
    src="https://dbwebb.se/image/snapht17/skrivbord.jpg"
    caption="Skaffa dig en trevlig arbetsmiljö som hjälper dig att fokusera på dina studier."
/>
...
Du kan ha en bärbar eller stationär, välj efter eget tycke. Kanske en av varje? Är du på campus är det bra att ha en av varje, men även som distansare kan det vara bra att ha sin labbmiljö på flera datorer.
...
Köp gärna mycket primärminne. Själv hade jag valt 32GB om jag hade ekonomi, 16GB fungerar nog bra. Webbläsare äter minne och det är bra att ha minne för virtualisering (att köra en dator i din dator).
...
Du vill ha en webbkamera (distansstudent), vi använder en som heter Logitech 920C (eller liknande). Men du klarar dig om datorn har en inbyggd kamera. Det är sällan du behöver använda kameran, men det är bra att ha när du tex spelar in en redovisningsvideo eller deltar i en onlineträff.

Du vill ha en mikrofon till datorn. Du klarar dig med en enkel, men det är inte dumt att investera i en bättre mikrofon som ger bra ljud. Men du klarar dig genom att använda dina lurar från mobilen. Låt din plånbok och ljud-ambition bestämma.
