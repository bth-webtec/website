...
title: Lab 04 csharp
revision:
    "2024-12-04": "(A, mos) First version."
---
Lab 04: Siffror, arrayer och inbyggda funktioner 
===========================

I denna laboration får du träna på siffror, arrayer och inbyggda funktioner.
...
Du har tidigare jobbat igenom lab 01 och lab 02.
...
```bash
dotnet new console -o lab_04
```

Projektet skapas i katalogen `lab_04` och du kan flytta ned i den katalogen.
...
```bash
wget -OutFile Program.cs https://gitlab.com/mikael-roos/programmering1/-/raw/main/lab/lab_04/Program.cs
wget -OutFile Module.cs https://gitlab.com/mikael-roos/programmering1/-/raw/main/lab/lab_04/Module.cs
wget -OutFile Lab.cs https://gitlab.com/mikael-roos/programmering1/-/raw/main/lab/lab_04/Lab.cs
```

När du är klar kan det se ut så här.

```bash
PS C:\Users\mos\lab_04> dir

    Directory: C:\Users\mos\lab_04
...
-a----         10/9/2024   7:35 AM            252 lab_04.csproj
...
wget -OutFile Solution.cs https://gitlab.com/mikael-roos/programmering1/-/raw/main/lab/lab_04/Solution.cs
```
