...
Om du vill koda med kan du hämta [sandboxen](https://github.com/webtec-2024/teacher/tree/main/example/sandbox).
...
Återigen, det finns många fler sätt att hantera elementen, även att radera dem. Det enklaste är dock `remove()`.
