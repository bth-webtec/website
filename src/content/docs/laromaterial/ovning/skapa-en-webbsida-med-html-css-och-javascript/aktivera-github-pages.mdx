...
ln -s public/me.html public/index.html
```
...
Du kan nu se att filen index.html pekar på (symbolisk länk till) me.html.

```console title="Se att index.html är en symbolisk länk."
lrwxrwxrwx 1 mos mos 14 sep  3 09:49 public/index.html -> public/me.html
```
