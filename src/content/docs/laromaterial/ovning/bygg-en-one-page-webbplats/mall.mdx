...
Skapa en ny webbsida `public/oneguide.html` med tillhörande stylesheet `public/css/oneguide.css` och en JavaScript-fil `public/js/oneguide.css`. 

Använd den kunksap du fått så här långt för att bygga grunden för webbsidan så att den innehåller en header och en footer. Välj ett passande färgschema och lägg till så att webbplatsen är responsiv.
