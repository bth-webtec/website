---
title: "Gör en PR (kmom10) ⚠️"
description: Instruktion om hur du gör en pull request (PR) för att lämna in kmom10.
sidebar:
    order: 0038
    # hidden: true
---
...
:::danger
Bilderna i denna artikel refererar till kmom03 och inte till kmom10.
:::


Följ denna instruktionen för att göra en pull request (PR) för att lämna in uppgiften i kmom10.



## Förutsättning

Du har uppfyllt kraven i uppgiften kmom10.
...
Din "base" skall vara `bth/submit/kmom10` (1 i bilden).

Din "compare" skall vara `main` (2 i bilden).

Det betyder att du vill merga `main` in till `bth/submit/kmom10`.

import pr4 from '@assets/pr/pr4.png';

<Figure 
    src={pr4}
    caption="Gör en PR för att merga main in till bth/submit/kmom10."
/>
...
Som **titel** skriver du "Inlämning av kmom10"
