...
1. Använd fetch för att hämta ankan.

1. Man ska kunna välja hur länge spelet håller på: 10, 30 eller 60 sekunder.

1. Man ska kunna välja i vilken hastighet ankan ska förflytta sig: 1, 2 eller 3 sekunders intervall.
