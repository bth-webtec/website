...
För att använda länkarna med fetch behöver vi "raw" content. Du kan se URL:en [här](https://raw.githubusercontent.com/bth-webtec/teacher/refs/heads/main/kmom06/backgrounds/1.jpg). Bara byt siffran i slutet. Detsamma gäller för ankan.
