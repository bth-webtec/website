...
dbw.assert(lab.sumLoop, [12], 66)
dbw.assert(lab.sumLoop, [42], 861)

dbw.assert(lab.sumLoop2, [3, 10], 42)
dbw.assert(lab.sumLoop2, [67, 104], 3145)

dbw.assert(lab.incIteration, [10, 2, 20], 50)
dbw.assert(lab.incIteration, [126, 42, 5], 336)

dbw.assert(lab.decIteration, [10, 2, 20], -30)
dbw.assert(lab.decIteration, [888, 42, 5], 678)

dbw.assert(lab.oddString, [10, 20], "11, 13, 15, 17, 19")
dbw.assert(lab.oddString, [43, 53], "43, 45, 47, 49, 51, 53")

dbw.assert(lab.incWhile, [42, 5, 60], 4)
