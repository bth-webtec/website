...
Du kommer att få svara på ett antal frågor som gör att eslint kan skapa en konfiguration åt dig. Här är svaren på frågorna.
...
Nu händer inget eftersom vi inte har några javascript-filer som kan analyseras, så allt är bra för tillfället.
