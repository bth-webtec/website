...
1. Jobba igenom artiklarna i "[Kom igång med DOM](./laromaterial/ovning/mera_javscript)" som hjälper dig med vilka konstruktioner vi har att använda när vi hanterar DOM.
