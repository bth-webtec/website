...
Här är en [summering av hur en sådan dialog kan se ut](https://chatgpt.com/share/689cabe1-7ef4-8005-848c-78b5c78c4ad6).

</details>

Skapa en ny session med din Ai-lärare för varje teknik och fyll sedan på med egna frågor för en fortsatt dialog.

Glöm inte att vara kritisk till informationen du får, precis som man vanligen är mot alla olika källor av information.
...
1. Jobba igenom övningen "[Skapa en webbsida med HTML, CSS och JavaScript](./laromaterial/ovning/skapa-en-webbsida-med-html-css-och-javascript)" som hjälper dig att komma igång och stegvis bygga en webbplats med HTML, CSS och JavaScript.
